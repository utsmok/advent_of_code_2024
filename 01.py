...
def __():
    # In-line input data as replacement for reading from file
    # If not defined, it will read data from file {day}/input.txt}
    col_1 = [28186,
    51854,
    19211,
    79370,
...
@app.cell
def __(col_1, col_2, determine_answers, parse_input):
    day = 1
    try:
        answer_1_str, answer_2_str = determine_answers(col_1, col_2)
    except Exception as e:
        # this'll happen if col_1 or col_2 are not defined, so we'll parse the input first
        answer_1_str, answer_2_str = determine_answers(parse_input(day))
    return answer_1_str, answer_2_str, day
